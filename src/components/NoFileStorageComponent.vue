...
<template>
  <div class="q-pa-xs fit row items-start">
    ...
    <div class="q-pt-lg q-px-lg fit row content-center justify-between no-wrap">
      ...
      <q-btn label="New Folder" class="button self-center" />
    </div>
  </div>
  <div>
    <q-img src="/src/assets/border.svg">
      <div
        class="q-pa-md self-center items-center justify-center"
